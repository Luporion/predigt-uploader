...
Der normale Terminal-Wizard bleibt der Standard für die Gemeinde-Nutzung. Eine experimentelle Textual-Oberfläche kann für Tests und Weiterentwicklung mit `python -m predigt_uploader tui` gestartet werden, wenn das optionale Extra `tui` installiert ist. Sie zeigt bisher Startmenü mit Statusbereich, prominenter Sicherheitsseite für beendete vMix-Aufnahme und beendeten Stream, geführte MP4-/Rohaufnahme-Auswahl als Tabelle, echte Metadaten-Erfassung mit Pflichtfeldprüfung und Live-Vorschau, Zielordner-Vorschau, eine MP4-Dateiübersicht und eine reine Einstellungen-Ansicht. Sie ersetzt den produktiven Workflow nicht.
