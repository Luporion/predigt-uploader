...
Der normale Terminal-Wizard bleibt der Standard für die Gemeinde-Nutzung. Eine experimentelle Textual-Oberfläche kann für Tests und Weiterentwicklung mit `python -m predigt_uploader tui` gestartet werden, wenn das optionale Extra `tui` installiert ist. Sie zeigt bisher Startmenü mit Statusbereich, Metadaten-/Dateiname-Vorschau, Zielordner-Vorschau, eine MP4-Dateiübersicht und eine reine Einstellungen-Ansicht. Sie ersetzt den produktiven Workflow nicht.
