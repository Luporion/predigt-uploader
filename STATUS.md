...
- Experimentellen Textual-Prototyp optional ueber `python -m predigt_uploader tui` starten, inklusive Statusbereich, beschrifteter Metadaten-Vorschau, Zielordner-Vorschau und Einstellungen-Anzeige.
